...
use Korus\Tgm\Onec\CUserCMLImport;
...
$arParams['UPDATE_PROPERTIES'][] = 'UF_MANAGER';
...
} elseif (!CModule::IncludeModule('korus.tgm')) {
    echo "failure\n", GetMessage("KORUS_TGM_ERROR_MODULE");
} else {
    ...
    if (($_GET["mode"] == "file") && $ABS_FILE_NAME) {
        ...
        if ($NS["STEP"] == 1) {
            ...
            if ($obImport->Init($NS, $WORK_DIR_NAME, $arParams)) {
                ...
                $obImport->UpdateDepartmentsHead();
            }
...
if (!$bDesignMode) {
    ...
    <tr>
        <td><? echo GetMessage("CP_BCI1_DEPARTMENTS_IBLOCK_ID") ?></td>
        <td><? echo $arParams["DEPARTMENTS_IBLOCK_ID"] ?></td>
    </tr>
    <tr>
        <td><? echo GetMessage("CP_BCI1_ABSENCE_IBLOCK_ID") ?></td>
        <td><? echo $arParams["ABSENCE_IBLOCK_ID"] ?></td>
    </tr>
    <tr>
        <td><? echo GetMessage("CP_BCI1_STRUCTURE_CHECK") ?></td>
        <td><? echo $arParams["STRUCTURE_CHECK"] ? GetMessage("MAIN_YES") : GetMessage("MAIN_NO") ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td><? echo GetMessage("CP_BCI1_UPDATE_PROPERTIES") ?></td>
        <td>
            <pre><?= implode('<br />', $arParams["UPDATE_PROPERTIES"]); ?></pre>
        </td>
    </tr>
    ...
    ?>
    <tr>
        <td><? echo GetMessage("CP_BCI1_DEFAULT_EMAIL") ?></td>
        <td><? echo $arParams["DEFAULT_EMAIL"] ?></td>
    </tr>
    <tr>
        <td><? echo GetMessage("CP_BCI1_LOGIN_TEMPLATE") ?></td>
        <td><? echo $arParams["LOGIN_TEMPLATE"] ?></td>
    </tr>
    <tr>
        <td><? echo GetMessage("CP_BCI1_EMAIL_PROPERTY_XML_ID") ?></td>
        <td><? echo $arParams["EMAIL_PROPERTY_XML_ID"] ?></td>
    </tr>
    <tr>
        <td><? echo GetMessage("CP_BCI1_LOGIN_PROPERTY_XML_ID") ?></td>
        <td><? echo $arParams["LOGIN_PROPERTY_XML_ID"] ?></td>
    </tr>
    <tr>
        <td><? echo GetMessage("CP_BCI1_PASSWORD_PROPERTY_XML_ID") ?></td>
        <td><? echo $arParams["PASSWORD_PROPERTY_XML_ID"] ?></td>
    </tr>
